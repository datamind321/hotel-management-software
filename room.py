...
class Room:
    def __init__(self,root):
        ...
        title.place(x=0,y=0,width=1295,height=50)
           ...
           #================== LOGO =============================
        img1=Image.open(r"C:\\Users\Dell\Documents\Projects Final Years\Hotel Management System\images\logohotel.png")
        ...
        conn=mysql.connector.connect(host="localhost",username="root",password="12345678",database="mydb")
        ...
        img2=Image.open(r"C:\\Users\Dell\Documents\Projects Final Years\Hotel Management System\images\bed.jpg")
